...
const NewGame = () => {
    ...
    const submit = useCallback((data: FormData) => {
        ...
        console.log(passwordHash, pot, referral);
    ...
    return (
        <Flex justifyContent='center' alignItems='center' width='100%' height='100%'>
            <form onSubmit={handleSubmit(submit)}>
                <StyledBackground>
                    <Box padding='16px'>
                    <TooltipLabel tooltipText='To project your game you can use password'>Password</TooltipLabel>
                    ...
                    <TooltipLabel tooltipText='Use a referral address if you want them to receive a commission for this game'>Referral</TooltipLabel>
                    <Flex flexDirection='row' margin={margin}>
                        <Flex justifyContent='center' alignItems='center' width='40px' height='40px' margin='0 8px 0 0'>
                            <Input
                                scale='xs'
                    ...
                    {errors.referral && <Message margin={margin} variant='warning'>Valid referral address is required</Message>}
